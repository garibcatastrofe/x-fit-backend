...
import { MedicionRouter } from './Mediciones/Infrastructure/Router';
import { RuffierRouter } from './Ruffiers/Infrastructure/Router';
...
app.use(PREFIX, MedicionRouter);
app.use(PREFIX, RuffierRouter);
